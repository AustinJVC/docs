...
## Authentication
As detailed in the Authentication guide, all requests must include your API key in the X-API-KEY HTTP header.
...
If you have any questions about making requests or encounter issues, please don't hesitate to reach out to our support team.